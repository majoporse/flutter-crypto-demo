...
our %config = (
  ...
  LDFLAGS => [  ],
  LDLIBS => [  ],
  PERL => "/home/linuxbrew/.linuxbrew/Cellar/perl/5.40.2/bin/perl",
  RANLIB => ":",
  RC => "windres",
  RCFLAGS => [  ],
  afalgeng => "",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)x86_64-linux-android21-clang",
  minor => "1.1",
